...
where
    ...
    FS2: FoldingSchemeFullGadget<
            ...
            1,
            VerifierKey = (),
            VC: CommitmentDefGadget<ConstraintField = FC::Field>,
        >,
{
    pub fn compute_next_state(
        ...
        let U_dummy = FS1::RU::new_constant(
            cs.clone(),
            <FS1::RU as GR1CSVar<_>>::Value::dummy(self.arith1_config),
        )?;
        ...
        let cf_U_dummy = FS2::RU::new_constant(
            cs.clone(),
            <FS2::RU as GR1CSVar<_>>::Value::dummy(self.arith2_config),
        )?;
        ...
        >,
{
    fn generate_constraints(
        ...
        self.compute_next_state(
            ...
            vec![Dummy::dummy(self.arith2_config); <FS1::RU as GR1CSVar<_>>::Value::N_COMMITMENTS],
            vec![Dummy::dummy(self.arith2_config); <FS1::RU as GR1CSVar<_>>::Value::N_COMMITMENTS],
        )
        .map(|_| ())
    }
...
pub trait CycleFoldConfig: Sized + Default {
    ...
    ) -> Result<Vec<<Self::C as Val>::Var>, SynthesisError>;
