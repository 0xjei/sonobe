...
where
    FS1: FoldingSchemeCycleFoldGadget<
            1,
            1,
            VC: CommitmentDefGadget<ConstraintField = FC::Field, ScalarVar = FpVar<FC::Field>>,
            CFScalarVar = <FS2::VC as CommitmentDefGadget>::ScalarVar,
        >,
    FS2: FoldingSchemeFullGadget<
            1,
            1,
            VC: CommitmentDefGadget<ConstraintField = FC::Field, ScalarVar: EqGadget<FC::Field>>,
        >,
{
    pub fn compute_next_state(
        ...
        U: <FS1::RU as GR1CSVar<FC::Field>>::Value,
        u: <FS1::IU as GR1CSVar<FC::Field>>::Value,
        proof: <FS1::Proof as GR1CSVar<FC::Field>>::Value,
        hint: <FS1::Hint as GR1CSVar<FC::Field>>::Value,
        cf_U: <FS2::RU as GR1CSVar<FC::Field>>::Value,
        cf_us: Vec<<FS2::IU as GR1CSVar<FC::Field>>::Value>,
        cf_proofs: Vec<<FS2::Proof as GR1CSVar<FC::Field>>::Value>,
        ...
        let U_dummy = FS1::RU::new_witness(cs.clone(), || {
            Ok(<FS1::RU as GR1CSVar<_>>::Value::dummy(&self.arith1_config))
        })?;
        ...
        let cf_U_dummy = FS2::RU::new_witness(cs.clone(), || {
            Ok(<FS2::RU as GR1CSVar<_>>::Value::dummy(&self.arith2_config))
        })?;
        ...
        >,
{
    fn generate_constraints(
        ...
        let U = <FS1::RU as GR1CSVar<FC::Field>>::Value::dummy(&self.arith1_config);
