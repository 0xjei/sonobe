...
impl<P: PolynomialRingConfig, F: SonobeField, const KAPPA: usize> CommitmentKey for AjtaiKey<P, F, KAPPA> {
...
impl<P: PolynomialRingConfig, F: SonobeField, const KAPPA: usize> CommitmentDef for Ajtai<P, F, KAPPA> {
...
impl<P: PolynomialRingConfig, F: SonobeField, const KAPPA: usize> CommitmentOps for Ajtai<P, F, KAPPA> {
    fn generate_key(len: usize, rng: impl RngCore) -> Result<Self::Key, Error> {
        Ok(AjtaiKey {
            m: vec![vec![Default::default(); len]; KAPPA], // TODO
        })
    }
    ...
    fn commit(
        ...
        Ok((vec![Default::default(); KAPPA], Null))
    }
